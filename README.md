...
* PHP (Laravel)
## descrizione
Esercizio-studio, volto a comprendere i concetti base di Laravel (Migration, Seed, Factory, Model, View, Route, Controller, Autenticazione, Registrazione Utenti).
